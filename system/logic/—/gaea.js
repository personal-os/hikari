...
$(document).on("click", "#contextSystem-about", function () {
  ...
  stuff += "<p id=\"about-copy\">&copy; 2014—2015 Paul Anthony Webb</p>";
...
(function(){var e,t,n,o,i,r,l;return i=function(e){return e.title=r(e.title,o('meta[name="application-name"]'),o('meta[property="og:title"]'),document.title.split(/\u0020[\/\\\|\-\u8211\u8212]\u0020|\:\u0020/)[0],""),e.author=r(e.author,o("meta[name=author]"),""),e.description=r(e.description,o("meta[name=description]"),o('meta[property="og:description"]'),""),e.image=r(e.image,o('meta[property="og:image"]'),o("meta[name=image]")),e.hue=e.hue||0,e.baseStyles=r(e.baseStyles,'color: #444; font-family: "Open Sans", "Source Sans Pro", Arial, sans-serif;'),e.titleStyles=r(e.titleStyles,""+e.baseStyles+"; font-size: 20px; line-height: 30px;"),e.authorStyles=r(e.authorStyles,""+e.baseStyles+"; font-size: 12px; line-height: 30px; padding: 0 0 0 20px;"),e.descriptionStyles=r(e.descriptionStyles,""+e.baseStyles+"; font-size: 10px; line-height: 20px;"),e},r=function(){var e,t,n;for(t=0,n=arguments.length;n>t;t++)if(e=arguments[t],"undefined"!=typeof e)return e;return arguments[arguments.length-1]},o=function(e){var t;return null!==(t=document.head.querySelector(e))?t.content:void 0},t=function(e){var t,n,o,i,r,l,a,s,u;for(l=["log","debug","warn","error"],i={},t={},o=[],n=l.length,a=function(e){return i[e]=console[e],t[e]=function(){return i[e].apply(console,arguments)},console[e]=function(){return void o.push([e,arguments])}},n=s=0,u=l.length;u>s;n=++s)r=l[n],a(r);return setTimeout(function(){var n;return n=function(){for(var e,t,n,a,s;o.length;)e=o.shift(),r=e[0],t=e[1],i[r].apply(console,t);for(s=[],n=0,a=l.length;a>n;n++)r=l[n],s.push(console[r]=i[r]);return s},e(t,n)},0)},n=function(e,t,n){var o,r;return r=function(){var o,i,r;if(e.title){if(!e.image){for(o=[""],r=0;r<e.title.length;)o[0]+="%c"+e.title[r]," "===e.title[r]?o.push(e.titleStyles):(i=(2*e.title[r].toLowerCase().charCodeAt(0)+e.hue)%255,o.push(""+e.titleStyles+"; background-color: #50bebf; color: transparent; line-height: 0;")),r++;t.log.apply(console,o)}e.author?t.log("%c"+e.title+"%c"+e.author,e.titleStyles,e.authorStyles):t.log("%c"+e.title,e.titleStyles)}return e.description&&t.log("%c"+e.description,e.descriptionStyles),n?n():void 0},t=t||window.console,e=e||window.signet.options||{enabled:!0},e.enabled!==!1?(e=i(e),e.image?(o=new Image,o.onload=function(){return t.log("%c ","font-size: 0; line-height: "+o.height+"px; padding: "+Math.floor(o.height/2)+"px "+o.width+"px "+Math.ceil(o.height/2)+'px 0; background-image: url("'+o.src+'");'),r()},o.src=e.image):r()):void 0},window.signet=window.signet||{},window.signet.options=window.signet.options||window.signetOptions||{},window.console&&window.console.log&&document.head&&document.querySelector?(e=!0,l=document.querySelector("[data-signet-draw]"),l&&(e="false"!==l.getAttribute("data-signet-draw").toLowerCase()),signet.options.draw===!1&&(e=!1),e&&t(function(e,t){return n(null,e,t)}),void(window.signet.draw=n)):void(window.signet.draw=function(){})}).call(this);
//