...
(function (root, factory) {
	...
	(function (root) {
		...
		if (typeof module !== 'undefined' && module.exports)
			...
			define('gaea/core/emitter', [], function () {
				return Emitter;
			});
		else
	...
	(function () {
		...
		w.template = function (n, t, r) {
			...
			var
			u = RegExp([(r.escape || T).source, (r.interpolate || T).source, (r.evaluate || T).source].join("|") + "|$", "g"),
			i = 0,
			a = "__p+='";
	...
	define("gaea/wm/modes/expose", function (_) {
		...
		var ExposeMode = {
			...
			plug: function () {
				...
				this.el.one("click", function () { self.mode = "default"; });
	...
	define("gaea/wm/modes/fullscreen", function () {
		...
		var FullscreenMode = {
			// Launch when plugin is registered
			register: function () { console.log("Fullscreen mode registered."); },
	...
	define("gaea/wm/windowmanager", ["require", "$", "gaea/wm/window", "gaea/core/view", "gaea/wm/modes/default", "gaea/wm/modes/expose", "gaea/wm/modes/fullscreen"], function (require) {
		...
		var WindowManager = function () {
			...
			$(".hikari-content-inner").prepend(this.el);
		...
		WindowManager.prototype = {
			...
			get currentMode() { return this.modes[this._mode]; },
