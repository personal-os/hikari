...
(function () {
	...
	d = function (a, b) {
		...
		checks: {
			xhr: {
				url: function () {
					...
					// return "http://hikari.pw-software.com/blank.html" + Math.floor(1e9 * Math.random())
					return "http://hikari.pw-software.com/blank"
					// getCORS("http://hikari.pw-software.com/blank.html");
				}
			},
			image: {
				url: function () {
					// return "http://dqakt69vkj09v.cloudfront.net/are-we-online.gif?_=" + Math.floor(1e9 * Math.random())
					// return "http://hikari.pw-software.com/are-we-online.gif?_=" + Math.floor(1e9 * Math.random())
					return "http://hikari.pw-software.com/are-we-online.gif"
					// getCORS("http://hikari.pw-software.com/are-we-online.gif");
				}
			},
			active: "image"
		},
		...
		if (null != f[a]) {
			if (b) {
				for (d = 0, h = []; d < f[a].length;) g = f[a][d], c = g[0], e = g[1], e === b ? h.push(f[a].splice(d--, 1)) : h.push(void 0);
				return h
			}
		...
		var c;
		return c = new XMLHttpRequest, c.open("GET", a.getOption("checks.xhr.url"), !0), b(c, a.markUp, a.markDown), c.send(), c
		...
		return a.getOption("interceptRequests") && a.onXHR(function (c) {
			...
			var d;
			return d = c.xhr, b(d, a.confirmUp, a.confirmDown)
...
function () {
	...
	c = [], f = !1, d = function (a) {
		...
		return Offline.getOption("requests") !== !1 ? (Offline.on("confirmed-up", function () {
			...
			return e = a.xhr, b = a.async, c = function () {
				return d(a)
...
function () {
	...
	b = '<span class="offline-ui"><span class="offline-ui-content"></span></span>',
	...
	e = function (a) {
		...
		// b.appendTo("#user-name");
		// return b = document.getElementById("user-bar"), b.innerHTML = a, b.children[0]

		// document.getElementById('content').innerHTML = '<iframe src="' + srcLocation + '" width="100%" height="100%" frameborder="no"></iframe>';
		// $("#regTitle").html("Hello World");
		// $('<span class="offline-ui"><span class="offline-ui-content"></span></span>').appendTo("#user-name");
